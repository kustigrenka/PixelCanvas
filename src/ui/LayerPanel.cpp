...
void LayerPanel::buildUi()
{
    ...
    m_blendCombo->addItems({ "Normal", "Multiply", "Screen",
                              "Overlay", "Add", "Luminosity" });
...
// ─────────────────────────────────────────────────────────────────────────────
// Refresh  –  sync all widgets to the current LayerStack state
// ─────────────────────────────────────────────────────────────────────────────
...
void LayerPanel::refresh()
{
    ...
    // Display layers top-to-bottom = highest index first (same as SAI).
    ...
    // Sync opacity, blend mode, and visibility to the active layer.
