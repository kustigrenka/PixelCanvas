...
// MainWindowDocks.cpp
//
// Dock construction for MainWindow: buildDocks() and the three dock-content
// builder helpers (Navigator, Color, Brush).
//
...
// ─────────────────────────────────────────────────────────────────────────────
// buildDocks  –  four independent docks
//
//   Left side (default)
...
//
//   Right side (default)
//     • Color      – colour wheel + swatches + sliders + scratch pad
...
void MainWindow::buildDocks()
{
    ...
    // Populate the Window menu with dock toggle actions.
...
// ─────────────────────────────────────────────────────────────────────────────
// Color widget  –  ColorPanelWidget (wheel + sliders + swatches + scratch)
// ─────────────────────────────────────────────────────────────────────────────

QWidget *MainWindow::buildColorWidget()
{
    m_colorPanel = new ColorPanelWidget(this);
    m_colorPanel->setMinimumWidth(200);
    m_colorPanel->setBrushEngine(m_brushEngine);
...
// ─────────────────────────────────────────────────────────────────────────────
// Brush widget  –  ToolbarPanel body wrapped in a scroll area
// ─────────────────────────────────────────────────────────────────────────────
