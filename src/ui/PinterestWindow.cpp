...
static constexpr char kPinterestUrl[] = "https://www.pinterest.com/";
...
void PinterestWindow::buildUI()
{
    ...
    m_urlBar = new QLineEdit(kPinterestUrl, navBar);
    ...
    goBtn->setStyleSheet(
        "QToolButton { background:#c0392b; color:#fff; border:none; border-radius:3px; font-size:13px; }"
        "QToolButton:hover { background:#e74c3c; }");
...
void PinterestWindow::mouseReleaseEvent(QMouseEvent *e)
{
    m_dragging = false;
