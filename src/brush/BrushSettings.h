...
struct BrushSettings
{
    ...
    bool isWetMedia()      const { return tipType == TipType::Brush
                                       || tipType == TipType::WaterColor
                                       || tipType == TipType::Marker; }

    bool hasBlurPressure() const { return tipType == TipType::WaterColor
                                       || tipType == TipType::Marker; }

    bool hasHardness()     const { return tipType != TipType::Blur
...
struct BrushPreset
{
    ...
    // Note: sizeMultiplier was previously 0.1f, which caused sub-pixel dabs
    //       and prevented drawing on first click. Fixed to 1.0f.
    static BrushPreset makePixelPencil()
    {
        BrushPreset p;
        p.name                   = "Pencil";
        p.settings.tipType       = TipType::Pixel;
        p.settings.size          = 10.0f;
        p.settings.sizeMultiplier = 1.0f;
        p.settings.hardness      = 0.95f;
        p.settings.spacing       = 0.05f;
    ...
    static BrushPreset makeAirbrush()
    {
        BrushPreset p;
        p.name             = "Airbrush";
        p.settings.tipType = TipType::Airbrush;
        p.settings.size    = 50.0f;
        p.settings.hardness = 0.0f;
        p.settings.spacing  = 0.05f;
        return p;
    }
    ...
    static BrushPreset makeBrush()
    {
        BrushPreset p;
        p.name                = "Brush";
        p.settings.tipType    = TipType::Brush;
        p.settings.size       = 50.0f;
        p.settings.hardness   = 0.80f;
        p.settings.blending   = 0.50f;
        p.settings.persistence = 0.50f;
        return p;
    }
    ...
    static BrushPreset makeWaterColor()
    {
        BrushPreset p;
        p.name                 = "Water Color";
        p.settings.tipType     = TipType::WaterColor;
        p.settings.size        = 50.0f;
        p.settings.hardness    = 0.85f;
        p.settings.blending    = 0.30f;
        p.settings.dilution    = 0.30f;
        p.settings.persistence = 0.50f;
        return p;
    }
    ...
    static BrushPreset makeEraser()
    {
        BrushPreset p;
        p.name                = "Eraser";
        p.settings.tipType    = TipType::Eraser;
        p.settings.size       = 50.0f;
        p.settings.hardness   = 0.85f;
        p.settings.blendMode  = BrushBlendMode::Erase;
        return p;
    }
    ...
    static BrushPreset makeSmudge()
    {
        BrushPreset p;
        p.name              = "Smudge";
        p.settings.tipType  = TipType::Smudge;
        p.settings.size     = 50.0f;
        p.settings.hardness = 0.80f;
        p.settings.coloring = 0.20f;
        return p;
    }
    ...
    static BrushPreset makeBlur()
    {
        BrushPreset p;
        p.name               = "Blur";
        p.settings.tipType   = TipType::Blur;
        p.settings.size      = 50.0f;
        p.settings.blurWidth = 0.50f;
        return p;
    }
};
